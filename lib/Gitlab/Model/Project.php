...
class Project extends AbstractModel
{
     ...
     * @return MergeRequest
     */
    public function createMergeRequest($source, $target, $title, $assignee = null, $description = null, $remove_source_branch = false)
    {
        $data = $this->client->mergeRequests()->create($this->id, $source, $target, $title, $assignee, $this->id, $description, [ 'remove_source_branch' => $remove_source_branch ]);
